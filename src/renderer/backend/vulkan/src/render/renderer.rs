...
pub struct Renderer {
    ...
    pub irradiance_texture: Option<Texture>,
    pub irradiance_view: Option<ImageView>,
    pub irradiance_sampler: Option<Sampler>,
    pub prefilter_texture: Option<Texture>,
    pub prefilter_view: Option<ImageView>,
    pub prefilter_sampler: Option<Sampler>,
...
impl Renderer {
    pub fn new(window: &winit::Window) -> Self {
        ...
        let mut renderer = Renderer {
            ...
            irradiance_sampler: None,
            prefilter_texture: None,
            prefilter_view: None,
            prefilter_sampler: None,
    ...
    pub fn load_assets(&mut self, asset_names: &[String]) {
        ...
        let (irradiance_texture, irradiance_view, irradiance_sampler) =
        ...
        self.irradiance_texture = Some(irradiance_texture);
        self.irradiance_view = Some(irradiance_view);
        self.irradiance_sampler = Some(irradiance_sampler);

        let (prefilter_texture, prefilter_view, prefilter_sampler) =
            Self::generate_prefilter_cubemap(
                self.context.clone(),
                &self.transient_command_pool,
                &cubemap,
                &cube,
