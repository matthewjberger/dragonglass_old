use crate::{
    ...
    resource::{
        Buffer, DescriptorPool, DescriptorSetLayout, Dimension, GltfAsset, Mesh, PipelineLayout,
        Primitive, Sampler, Shader, Texture, TextureDescription, VulkanGltfAsset, VulkanTexture,
    },
};
